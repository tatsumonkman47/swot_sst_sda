...
# Source: modulus/utils/filesystem.py, version 0.7.0a0
...
class Package:
    """A generic file system abstraction for local and remote file systems.
    ...
    def get(self, path: str, recursive: bool = False) -> str:
        """Get a local path to the item at ``path``, downloading to cache if remote."""
