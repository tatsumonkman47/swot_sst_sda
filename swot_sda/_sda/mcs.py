r"""Markov chains — vendored from https://github.com/francois-rozet/sda
...
Note: JAX and jax-cfd are optional dependencies required only by KolmogorovFlow.
"""
...
class KolmogorovFlow(MarkovChain):
    ...
    Requires: jax, jax-cfd  (``pip install jax jax-cfd``)
    """
    ...
    def __init__(
        ...
        if not _HAS_JAX or not _HAS_JAX_CFD:
            raise ImportError(
                "KolmogorovFlow requires JAX and jax-cfd: pip install jax jax-cfd"
            )
