r"""Score modules — vendored from https://github.com/francois-rozet/sda
...
class MCScoreWrapperNoChannel(nn.Module):
    def __init__(self, score: nn.Module):
        super().__init__()
        self.score = score
...
class eps_edm(nn.Module):
    r"""Converts denoising model trained in the EDM framework (Karras et al. 2022) to the
    epsilon used in SDA (Rozet & Louppe 2023), following the formula from appendix of
    Manshausen et al. 2024.
